...
- [内容引用/导入/发布打包差距记录](./docs/architecture/content-reference-gaps.md)
- [内部引用协议方案（已拍板）](./docs/architecture/content-reference-protocol.md)
- [内部引用实现设计](./docs/architecture/content-reference-implementation.md)
- [在线演示改造（对齐 AI_Web_Presentation 设计）](./docs/architecture/presentation-redesign.md)
